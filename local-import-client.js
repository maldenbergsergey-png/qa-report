...
(function (root) {
  ...
  async function acceptBatch(batch, current) {
    ...
    if (batch.kind === "checklist") {
      // Enabling reception authorizes replacement within this report-bound session.
