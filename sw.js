...
const CACHE_NAME = "qa-report-shell-v44";
const SHELL = [
  ...
  "/", "/styles.css?v=99", "/app.js?v=106", "/pwa.js?v=2",
  "/jira-markup-import.js?v=6", "/checklist-selection.js?v=2",
  "/checklist-numbering.js?v=2", "/release-notes.js?v=21",
