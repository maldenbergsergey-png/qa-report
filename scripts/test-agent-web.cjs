...
async function main() {
  ...
  await page.route('**/api/agent/status', route => route.fulfill({ json: { devices: [{ online:true, name:'QA Agent', version:'0.4.1', jiraBaseUrl:urls[0], jiraBaseUrls:urls }] } }));
  await page.route('**/api/agent/downloads', route => route.fulfill({ json: { downloads: [
    { platform:'mac-arm64', label:'macOS · Apple Silicon', version:'0.4.1', url:'https://github.com/maldenbergsergey-png/qa-report/releases/download/agent-v0.4.1/qa-report-agent-0.4.1-mac-arm64.dmg', available:true },
    { platform:'windows', label:'Windows · x64', version:'0.4.1', url:'https://github.com/maldenbergsergey-png/qa-report/releases/download/agent-v0.4.1/qa-report-agent-0.4.1-windows-x64.exe', available:true }
  ] } }));
  ...
  assert.equal(download, 'https://github.com/maldenbergsergey-png/qa-report/releases/download/agent-v0.4.1/qa-report-agent-0.4.1-mac-arm64.dmg');
  await page.locator('#desktopAgentDownloads select').selectOption('https://github.com/maldenbergsergey-png/qa-report/releases/download/agent-v0.4.1/qa-report-agent-0.4.1-windows-x64.exe');
  assert.equal(await page.locator('#desktopAgentDownloads a').getAttribute('href'), 'https://github.com/maldenbergsergey-png/qa-report/releases/download/agent-v0.4.1/qa-report-agent-0.4.1-windows-x64.exe');
  ...
  assert.match(await page.locator('#desktopAgentDownloads select').textContent(), /0\.4\.1/);
