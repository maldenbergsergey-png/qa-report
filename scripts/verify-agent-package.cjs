...
const targets = {
  mac: ["mac-arm64"].map(dir => `${dir}/QA Report Agent.app/Contents/Resources/app.asar`),
...
for (const relative of targets[process.argv[2]]) {
  ...
  for (const name of ["qa-report-agent.js", "jira-profiles.js", "desktop/main.js", "desktop/network.js", "bootstrap/main.js", "bootstrap/updates.js", "bootstrap/release-key.pem", "bootstrap/policy.json"]) {
