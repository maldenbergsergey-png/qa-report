...
COPY --chown=node:node local-import-server.js jira-attachment-transfer.js attachment-limits.js attachment-import.js jira-attachment-reuse.js local-import-client.js ./
